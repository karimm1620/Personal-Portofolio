document.addEventListener('DOMContentLoaded', function () {
    ...
    // Smooth scroolling for acnchor links
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function (e) {
            ...
            // Kaya gini contohnya klo berhasil
            console.log('Form Submitted:', { name, email, message });

            // Contoh klo pesan berhasil masuk
    ...
    // Terminal animation bagian favorit wkwkwk
    ...
    if (terminalContainer && terminalContent && commandSpan) {
        const commandText = "git clone https://github.com/karimm1620/Personal-Portfolio.git";
